...
</style><script type="text/javascript" async="" src="./python final project(2)_files/recaptcha__en.js.download" crossorigin="anonymous" integrity="sha384-tL/88+JE9Mv/pJzkZt5DBcS7efRA2LrT4YX0Htu8Rnmat69OIBwraynHJm/fWfbH" nonce=""></script><script type="text/javascript" async="" src="./python final project(2)_files/recaptcha__en.js.download" crossorigin="anonymous" integrity="sha384-tL/88+JE9Mv/pJzkZt5DBcS7efRA2LrT4YX0Htu8Rnmat69OIBwraynHJm/fWfbH" nonce=""></script><script src="./python final project(2)_files/cb=gapi.loaded_1" nonce="" async=""></script><script src="./python final project(2)_files/cb=gapi.loaded_0" nonce="" async=""></script><script async="" src="./python final project(2)_files/analytics.js.download"></script><script nonce="">
...
</custom-style><link rel="stylesheet" href="./python final project(2)_files/css(2)"><link rel="stylesheet" href="./python final project(2)_files/css(3)"><custom-style>
  <style is="custom-style">html {
...
</custom-style><script async="" type="text/javascript" charset="UTF-8" src="./python final project(2)_files/rs=AA2YrTt4JOvu-XHi8QmKp3AOa-PQHoGXcQ" nonce=""></script><link rel="stylesheet" type="text/css" data-name="vs/editor/editor.main" href="./python final project(2)_files/editor.main.css"><link type="text/css" rel="stylesheet" href="./python final project(2)_files/rs=AA2YrTsWRnrrjjX-NScT7dDyhx7N0cjs1w"><style type="text/css">.MathJax_Hover_Frame {border-radius: .25em; -webkit-border-radius: .25em; -moz-border-radius: .25em; -khtml-border-radius: .25em; box-shadow: 0px 0px 15px #83A; -webkit-box-shadow: 0px 0px 15px #83A; -moz-box-shadow: 0px 0px 15px #83A; -khtml-box-shadow: 0px 0px 15px #83A; border: 1px solid #A6D ! important; display: inline-block; position: absolute}
...
</style><script async="async" type="text/javascript" src="./python final project(2)_files/editor.main.js.download"></script><script async="async" type="text/javascript" src="./python final project(2)_files/editor.main.nls.js.download"></script><script src="./python final project(2)_files/api.js.download" nonce=""></script><script src="./python final project(2)_files/api.js(1).download" nonce=""></script><style type="text/css" media="screen" class="monaco-colors">.codicon-add:before { content: '\ea60'; }
...
.mtku { text-decoration: underline; text-underline-position: under; }</style><style type="text/css" media="screen">
		...
		</style><script async="async" type="text/javascript" src="./python final project(2)_files/python.js.download"></script></head><body class="" style="overscroll-behavior: contain;"><div style="visibility: hidden; overflow: hidden; position: absolute; top: 0px; height: 1px; width: auto; padding: 0px; border: 0px; margin: 0px; text-align: left; text-indent: 0px; text-transform: none; line-height: normal; letter-spacing: normal; word-spacing: normal;"><div id="MathJax_Hidden"></div></div><div id="MathJax_Message" style="display: none;"></div><div class="scripts"><script nonce="">window.performance.mark('external_scripts_start');</script><script src="./python final project(2)_files/gapi_loader.js.download" nonce=""></script><script src="./python final project(2)_files/external.js.download" nonce=""></script><script src="./python final project(2)_files/MathJax.js.download" nonce=""></script><script src="./python final project(2)_files/loader.js.download" nonce=""></script><script nonce="">window.performance.mark('external_scripts_end'); window.performance.measure('external_scripts', 'external_scripts_start', 'external_scripts_end'); window.performance.mark('colab_load_start');
          window.Polymer = {
            'legacyOptimizations': true,
          };
          </script><script src="./python final project(2)_files/external_polymer_binary.js.download" nonce=""></script><script nonce="">
...
(renusreemalapati@gmail.com)" href="https://accounts.google.com/SignOutOptions?hl=en&amp;continue=https://colab.research.google.com/" role="button" tabindex="0"><img class="gb_Ca gbii" src="./python final project(2)_files/unnamed.png" srcset="https://lh3.googleusercontent.com/ogw/AOh-ky2O9xvaWNEPpc-8-jKEeoKrgpy0OUeOzenlwkSY=s32-c-mo 1x, https://lh3.googleusercontent.com/ogw/AOh-ky2O9xvaWNEPpc-8-jKEeoKrgpy0OUeOzenlwkSY=s64-c-mo 2x " alt="" aria-hidden="true" data-noaft=""></a><div class="gb_5a"></div><div class="gb_4a"></div></div></div></div><div style="overflow: hidden; position: absolute; top: 0px; visibility: hidden; width: 372px; z-index: 991; height: 0px; margin-top: 57px; right: 0px; margin-right: 4px;"></div></div></div><script nonce="">this.gbar_=this.gbar_||{};(function(_){var window=this;
try{
...
Ctrl+M B">
  ...
  <div class="layout vertical grow">
    ...
    <div class="layout vertical grow tab-pane-container">
      ...
      <div class="proxies"><div><colab-dom-lifecycle-events></colab-dom-lifecycle-events><iframe allow="" sandbox="allow-downloads allow-forms allow-pointer-lock allow-popups allow-same-origin allow-scripts allow-popups-to-escape-sandbox" src="./python final project(2)_files/outputframe.html" style="width: 1px; height: 1px; position: absolute; top: -100px;"></iframe></div><div><colab-dom-lifecycle-events></colab-dom-lifecycle-events><iframe allow="accelerometer; autoplay; camera; gyroscope; magnetometer; microphone; serial; usb; xr-spatial-tracking; clipboard-write" sandbox="allow-downloads allow-forms allow-pointer-lock allow-popups allow-same-origin allow-scripts allow-popups-to-escape-sandbox" src="./python final project(2)_files/outputframe(1).html" style="width: 1px; height: 1px; position: absolute; top: -100px;"></iframe></div></div>
